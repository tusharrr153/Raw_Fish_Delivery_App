            ...
            public void onClick(View v) {
                if (!inputnumber1.getText().toString().trim().isEmpty()
                    ...
                    if (getotpbackend != null) {
                        ...
                        Toast.makeText(verifyenterotptwo1.this, "Please check internet connection", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(verifyenterotptwo1.this, "Please enter all numbers", Toast.LENGTH_SHORT).show();
                }
            }
        });
